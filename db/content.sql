...
INSERT INTO Console Values (1,'Wii',100,'La Wii  est une console de jeux vidéo de salon du fabricant japonais Nintendo. Console de la septième génération, tout comme la Xbox 360 et la PlayStation 3 avec lesquelles elle est en rivalité, elle est la console de salon la plus vendue de sa génération et a comme particularité d\'utiliser un accéléromètre capable de détecter la position, l\'orientation et les mouvements dans l\'espace de la manette','Nintendo','wii.jpg');


INSERT INTO Console Values (2,'Nintendo 64' ,50,'La Nintendo 64, également connue sous les noms de code Project Reality et Ultra 64 lors de sa phase de développement, est une console de jeux vidéo de salon, sortie en 1996 (1997 en Europe), du constructeur japonais Nintendo en collaboration avec Silicon Graphics. Elle fut la dernière des consoles de cinquième génération à être sortie, en concurrence avec la Saturn et la PlayStation.','Nintendo','N64.jpg');

INSERT INTO Console Values (3,'Super NES' ,50,'La Super Nintendo Entertainment System (couramment abrégée Super NES ou Super Nintendo3), ou Super Famicom au Japon, est une console de jeux vidéo 16 bits du constructeur japonais Nintendo commercialisée à partir de novembre 1990. En Amérique du Nord, la console est sortie avec un look résolument différent. À noter qu\'en Corée du Sud, la Super Nintendo est distribuée par Hyundai Electronics sous le nom de Super Comboy','Nintendo', 'snes.jpg');

INSERT INTO Console Values (4, 'Borne Arcade', 0, 'Une borne d\'arcade est un meuble contenant un jeu vidéo payant dit « jeu vidéo d\'arcade ». On les trouve habituellement dans des lieux ouverts au public comme les bars, les centres commerciaux, certains établissements de divertissement (bowlings, patinoires, cinémas multiplexe, etc.) ainsi que les salles d\'arcade.', 'Unknown','borne.png');
